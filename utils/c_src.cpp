...
void add_features_batch(int lg, float* out, double* history, int num_rows){
    ...
    for (int i = 0; i < num_rows; i++){
        add_features(lg, out + (1590 * i), history);
    }
}
...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 4), // int()(double)
/*  1 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 14), // double
/*  2 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  3 */ _CFFI_OP(_CFFI_OP_FUNCTION, 41), // void()(int, double *)
/*  4 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/*  5 */ _CFFI_OP(_CFFI_OP_POINTER, 1), // double *
/*  6 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  7 */ _CFFI_OP(_CFFI_OP_FUNCTION, 41), // void()(int, float *, double *, int)
/*  8 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7),
/*  9 */ _CFFI_OP(_CFFI_OP_POINTER, 40), // float *
/* 10 */ _CFFI_OP(_CFFI_OP_NOOP, 5),
/* 11 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7),
/* 12 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 13 */ _CFFI_OP(_CFFI_OP_FUNCTION, 41), // void()(long, float *, double *)
/* 14 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 9), // long
/* 15 */ _CFFI_OP(_CFFI_OP_NOOP, 9),
/* 16 */ _CFFI_OP(_CFFI_OP_NOOP, 5),
/* 17 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 18 */ _CFFI_OP(_CFFI_OP_FUNCTION, 41), // void()(long, long *, double *, long *, long *, long *, long *, long *, long *, double *, double *, double *, double *, long *, long *, long *, long *, double *, double *, long)
/* 19 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 9),
/* 20 */ _CFFI_OP(_CFFI_OP_POINTER, 14), // long *
...
static void _cffi_d_add_features(long x0, float * x1, double * x2)
{
  add_features(x0, x1, x2);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_add_features(PyObject *self, PyObject *args)
{
  long x0;
  float * x1;
  double * x2;
  ...
  if (!PyArg_UnpackTuple(args, "add_features", 3, 3, &arg0, &arg1, &arg2))
    return NULL;
...
#else
#  define _cffi_f_add_features _cffi_d_add_features
#endif

static void _cffi_d_add_features_batch(int x0, float * x1, double * x2, int x3)
{
  add_features_batch(x0, x1, x2, x3);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_add_features_batch(PyObject *self, PyObject *args)
{
  int x0;
  float * x1;
  double * x2;
  ...
  if (!PyArg_UnpackTuple(args, "add_features_batch", 4, 4, &arg0, &arg1, &arg2, &arg3))
    return NULL;
...
#else
#  define _cffi_f_add_features_batch _cffi_d_add_features_batch
#endif

static int _cffi_d_check_if_double_is_nan(double x0)
{
  return check_if_double_is_nan(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_check_if_double_is_nan(PyObject *self, PyObject *arg0)
{
  double x0;
  int result;
  PyObject *pyresult;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = check_if_double_is_nan(x0); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
#else
#  define _cffi_f_check_if_double_is_nan _cffi_d_check_if_double_is_nan
#endif

static void _cffi_d_fill_history(long x0, long * x1, double * x2, long * x3, long * x4, long * x5, long * x6, long * x7, long * x8, double * x9, double * x10, double * x11, double * x12, long * x13, long * x14, long * x15, long * x16, double * x17, double * x18, long x19)
{
  fill_history(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_fill_history(PyObject *self, PyObject *args)
{
  long x0;
  long * x1;
  double * x2;
  ...
  if (!PyArg_UnpackTuple(args, "fill_history", 20, 20, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10, &arg11, &arg12, &arg13, &arg14, &arg15, &arg16, &arg17, &arg18, &arg19))
    return NULL;
  ...
  if (datasize != 0) {
    x13 = ((size_t)datasize) <= 640 ? (long *)alloca((size_t)datasize) : NULL;
  ...
  if (datasize != 0) {
    x14 = ((size_t)datasize) <= 640 ? (long *)alloca((size_t)datasize) : NULL;
  ...
  if (datasize != 0) {
    x15 = ((size_t)datasize) <= 640 ? (long *)alloca((size_t)datasize) : NULL;
  ...
  if (datasize != 0) {
    x16 = ((size_t)datasize) <= 640 ? (long *)alloca((size_t)datasize) : NULL;
  ...
  datasize = _cffi_prepare_pointer_call_argument(
      _cffi_type(5), arg17, (char **)&x17);
  if (datasize != 0) {
    x17 = ((size_t)datasize) <= 640 ? (double *)alloca((size_t)datasize) : NULL;
    if (_cffi_convert_array_argument(_cffi_type(5), arg17, (char **)&x17,
            datasize, &large_args_free) < 0)
      return NULL;
  }

  datasize = _cffi_prepare_pointer_call_argument(
      _cffi_type(5), arg18, (char **)&x18);
  if (datasize != 0) {
    x18 = ((size_t)datasize) <= 640 ? (double *)alloca((size_t)datasize) : NULL;
    if (_cffi_convert_array_argument(_cffi_type(5), arg18, (char **)&x18,
            datasize, &large_args_free) < 0)
      return NULL;
  }

  x19 = _cffi_to_c_int(arg19, long);
  if (x19 == (long)-1 && PyErr_Occurred())
    return NULL;
...
#else
#  define _cffi_f_fill_history _cffi_d_fill_history
#endif

static void _cffi_d_init_history(int x0, double * x1)
{
  init_history(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_init_history(PyObject *self, PyObject *args)
{
  int x0;
  double * x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "init_history", 2, 2, &arg0, &arg1))
    return NULL;
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "add_features", (void *)_cffi_f_add_features, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 13), (void *)_cffi_d_add_features },
  { "add_features_batch", (void *)_cffi_f_add_features_batch, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 7), (void *)_cffi_d_add_features_batch },
  { "check_if_double_is_nan", (void *)_cffi_f_check_if_double_is_nan, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 0), (void *)_cffi_d_check_if_double_is_nan },
  { "fill_history", (void *)_cffi_f_fill_history, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 18), (void *)_cffi_d_fill_history },
  { "init_history", (void *)_cffi_f_init_history, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 3), (void *)_cffi_d_init_history },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_JoWilder_C_features(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_JoWilder_C_features(void) { return NULL; }
#  else
     initJoWilder_C_features(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_JoWilder_C_features(void)
{
  return _cffi_init("JoWilder_C_features", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initJoWilder_C_features(void)
{
  _cffi_init("JoWilder_C_features", 0x2601, &_cffi_type_context);
}
#endif
